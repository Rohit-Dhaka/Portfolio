    ...
    return (
        <footer className=' bg-gradient-to-t  to-[#11071F] from-black overflow-hidden  bg-[#11071F] '>
            ...
            <a href="" className='w-8 h-8 bg-white   rounded-full hover:shadow-glow duration-300 ease-linear group  flex items-center justify-center'> <div className=" group-hover:scale-110 duration-300  ease-linear"> <SocalTwiter/> </div></a>
                       ...
                       <ul className='flex sm:gap-[18px] gap-[12px]'>                            
                            <li>
                                <a href="" className=" text-white hover:text-[#A362FF] duration-300 relative after:absolute after:bottom-0 after:left-1/2 after:translate-x-[-50%] after:h-[2px] after:w-0 after:duration-300 after:bg-[#A362FF] after:hover:left-0 after:hover:translate-x-0 after:hover:w-full font-poppins">Home</a>
                            </li>

                            <li>
                                <a href="" className=" text-white hover:text-[#A362FF] duration-300 relative after:absolute after:bottom-0 after:left-1/2 after:translate-x-[-50%] after:h-[2px] after:w-0 after:duration-300 after:bg-[#A362FF] after:hover:left-0 after:hover:translate-x-0 after:hover:w-full font-poppins">Skills</a>
                            </li>

                            <li>
                                <a href="" className=" text-white hover:text-[#A362FF] duration-300 relative after:absolute after:bottom-0 after:left-1/2 after:translate-x-[-50%] after:h-[2px] after:w-0 after:duration-300 after:bg-[#A362FF] after:hover:left-0 after:hover:translate-x-0 after:hover:w-full font-poppins">Project</a>
                            </li>



                            <li>
                                <a href="" className=" text-white hover:text-[#A362FF] duration-300 relative after:absolute after:bottom-0 after:left-1/2 after:translate-x-[-50%] after:h-[2px] after:w-0 after:duration-300 after:bg-[#A362FF] after:hover:left-0 after:hover:translate-x-0 after:hover:w-full font-poppins">Contact Me</a>
                            </li>
