  ...
  return (
    <header className="bg-[#0B0B0B] h-screen flex items-center justify-center  relative overflow-hidden" >
      ...
      <div className="max-w-[1140px] mx-auto px-[16px] flex flex-col items-center text-center">
        <h1 className=" font-rubik lg:text-[64px] text-[42px] font-bold max-sm:leading-[130%] text-white  max-w-[940px]" data-aos="zoom-in">
          Hi, Myself Rohit Dhaka <span className="lg:inline-block">And I'm a <span className="text-[#6022EA]">Frontend Developer</span></span>
        </h1>
